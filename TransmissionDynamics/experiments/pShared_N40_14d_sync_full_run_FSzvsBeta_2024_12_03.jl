...
output_label_outer = "full_run_FSvsBeta_14d_sync_2024_12_03"
...
function configure_run(seed_infections::Int64, 
                       ...
                       ex::TransmissionDynamics.Experiment_Constants,
                       q_vs_t_flag::Bool,
                       n_index_cases::Int64)::TransmissionDynamics.Config
                            ...
                            for VfacDbl in VfacDbl_vals
                                ...
                                for b in betas 
                                    ...
                                    #for i in 1:n_runs
                                        ...
                                        c = configure_run(seed_i, seed_i, b, ex, q_vs_t_flag, n_index_cases)
