...
for index_case_cfg = index_case_config_vals
    ...
    experiment_label = ['N' N '_full_run_pShared_14d_sync_2024_11_29'];
...
v1 = output_table.pS0p0_ACHp6p0_ACHb2p0_V1p5_AR_nurse;
v2 = output_table.pS1p0_ACHp6p0_ACHb2p0_V1p5_AR_nurse;

% legend text. 
leg_txt = {'single-occupancy', 'double-occupancy'};
...
v1 = output_table.pS0p0_ACHp6p0_ACHb2p0_V1p5_AR_patient;
v2 = output_table.pS1p0_ACHp6p0_ACHb2p0_V1p5_AR_patient;
